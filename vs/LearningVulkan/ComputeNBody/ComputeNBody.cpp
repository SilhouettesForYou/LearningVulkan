...
class VulkanExampleComputeNBody : public VulkanBase
{
public:
	...
	VulkanExampleComputeNBody() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleComputeNBody)