...
class VulkanExampleComputeHeadless
{
public:
	VkInstance instance;
		...
		*/
		{
			...
			const std::string shadersPath = GetAssetPath() + "shaders/computeheadless/";
...
#else
int main() {
	auto vulkanExample = new VulkanExampleComputeHeadless();
