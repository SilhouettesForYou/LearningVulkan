...
class VulkanExampleDeferredMultiSampling : public VulkanBase
{
public:
	...
	VulkanExampleDeferredMultiSampling() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleDeferredMultiSampling()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleDeferredMultiSampling)