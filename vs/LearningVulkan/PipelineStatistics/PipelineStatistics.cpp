...
class VulkanExamplePipelineStatistics : public VulkanBase
{
public:
	...
	VulkanExamplePipelineStatistics() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExamplePipelineStatistics()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExamplePipelineStatistics)