...
class VulkanExampleTextureCubeMap : public VulkanBase
{
public:
	...
	VulkanExampleTextureCubeMap() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleTextureCubeMap)