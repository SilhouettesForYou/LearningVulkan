...
public:
	...
	void AddText(std::string text, float x, float y, TextAlign align)
	{
		...
		{
			auto charData = &stbFontData[(uint32_t)letter - firstChar];
...
*/
class VulkanExampleTextOverlay : public VulkanBase
{
public:
	...
	VulkanExampleTextOverlay() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleTextOverlay)