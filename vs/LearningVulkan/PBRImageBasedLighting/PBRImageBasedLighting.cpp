...
class VulkanExamplePBRImageBasedLighting : public VulkanBase
{
public:
	...
	VulkanExamplePBRImageBasedLighting() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExamplePBRImageBasedLighting()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExamplePBRImageBasedLighting)