...
class VulkanExampleMultiSampling : public VulkanBase
{
public:
	...
	VulkanExampleMultiSampling() : VulkanBase(ENABLE_VALIDATION)
	{
		title = "Multisampling";
...
VULKAN_EXAMPLE_MAIN(VulkanExampleMultiSampling)