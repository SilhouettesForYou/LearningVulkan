...
class VulkanExampleTexture3D : public VulkanBase
{
public:
	...
	VulkanExampleTexture3D() : VulkanBase(ENABLE_VALIDATION)
	{
		title = "3D textures";
...
VULKAN_EXAMPLE_MAIN(VulkanExampleTexture3D)