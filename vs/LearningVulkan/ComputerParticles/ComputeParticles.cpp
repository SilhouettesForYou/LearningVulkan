...
class VulkanExampleComputeParticle : public VulkanBase
{
public:
	float timer = 0.0f;
	...
	VulkanExampleComputeParticle() : VulkanBase(ENABLE_VALIDATION)
	{
		title = "Compute shader particle system";
		settings.overlay = true;
	}

	~VulkanExampleComputeParticle()
	{
		// Graphics
...
VULKAN_EXAMPLE_MAIN(VulkanExampleComputeParticle)