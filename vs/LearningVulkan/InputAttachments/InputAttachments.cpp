...
class VulkanExampleInputAttachments : public VulkanBase
{
public:
	// Vertex layout for models
	...
	VulkanExampleInputAttachments() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	void SetupRenderPass()
	{
		...
		// and then read in the second subpass
...
VULKAN_EXAMPLE_MAIN(VulkanExampleInputAttachments)
