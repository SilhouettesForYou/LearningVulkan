...
class VulkanExampleTexture : public VulkanBase
{
public:
	...
	VulkanExampleTexture() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleTexture)