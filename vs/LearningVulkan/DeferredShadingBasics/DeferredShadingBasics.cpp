...
class VulkanExampleDeferedShadingBasics : public VulkanBase
{
public:
	...
	VulkanExampleDeferedShadingBasics() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleDeferedShadingBasics()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleDeferedShadingBasics)