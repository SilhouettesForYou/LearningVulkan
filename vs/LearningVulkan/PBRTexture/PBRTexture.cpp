...
class VulkanExamplePBRTexture : public VulkanBase
{
public:
	...
	VulkanExamplePBRTexture() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExamplePBRTexture)