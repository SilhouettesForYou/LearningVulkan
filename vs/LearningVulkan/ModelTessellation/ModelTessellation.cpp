...
class VulkanExampleModelTessellation : public VulkanBase
{
public:
	...
	VulkanExampleModelTessellation() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleModelTessellation()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleModelTessellation)