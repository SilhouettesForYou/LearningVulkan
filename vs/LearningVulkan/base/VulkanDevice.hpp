    ...
    struct VulkanDevice
    {
		...
		*/
        uint32_t GetQueueFamilyIndex(VkQueueFlagBits queueFlags)
        {
            ...
            if (queueFlags & VK_QUEUE_COMPUTE_BIT)
            {
                ...
                {
                    if (queueFlags & queueFamilyProperties[i].queueFlags 
                        && !(VK_QUEUE_GRAPHICS_BIT & queueFamilyProperties[i].queueFlags))
                    {
                        return i;
                    }
                }
		...
		*/
        VkResult CreateBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, VkDeviceSize size, VkBuffer* buffer, VkDeviceMemory* memory, void* data = nullptr)
        {
            ...
            memAlloc.memoryTypeIndex = GetMemoryType(memRequirements.memoryTypeBits, memoryPropertyFlags);
            ...
            // Attach memory to buffer object
		...
		*/
        VkResult CreateBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, vks::Buffer *buffer, VkDeviceSize size, void *data = nullptr)
		{
			...
			buffer->aligment = memReqs.alignment;
			buffer->size = size;
