...
class VulkanExampleComputeCullAndLod : public VulkanBase
{
public:
	...
	VulkanExampleComputeCullAndLod() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleComputeCullAndLod()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleComputeCullAndLod)