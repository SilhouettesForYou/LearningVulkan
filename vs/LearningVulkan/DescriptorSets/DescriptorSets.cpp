...
class VulkanExampleDescriptorSets : public VulkanBase
{
public:
	bool animate = true;
	...
	VulkanExampleDescriptorSets() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleDescriptorSets)