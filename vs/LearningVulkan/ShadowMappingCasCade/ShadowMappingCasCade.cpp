...
class VulkanExampleShadowMappingCascade : public VulkanBase
{
public:
	...
	VulkanExampleShadowMappingCascade() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleShadowMappingCascade()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleShadowMappingCascade)