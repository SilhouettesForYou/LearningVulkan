...
class VulkanExampleGltfScene : public VulkanBase
{
public:
	...
	VulkanExampleGltfScene() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleGltfScene)