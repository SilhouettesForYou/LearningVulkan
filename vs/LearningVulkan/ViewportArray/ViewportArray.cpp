...
class VulkanExampleViewportArray : public VulkanBase
{
public:
	...
	VulkanExampleViewportArray() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleViewportArray)