...
class VulkanExampleRadialBlur : public VulkanBase
{
public:
	bool blur = true;
	...
	VulkanExampleRadialBlur() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleRadialBlur)