...
class VulkanExampleOmnidirectionalShadowMapping : public VulkanBase
{
public:
	...
	VulkanExampleOmnidirectionalShadowMapping() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleOmnidirectionalShadowMapping()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleOmnidirectionalShadowMapping)
