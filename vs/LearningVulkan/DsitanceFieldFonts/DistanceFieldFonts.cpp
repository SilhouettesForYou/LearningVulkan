...
class VulkanExampleDistanceFieldFonts : public VulkanBase
{
public:
	...
	VulkanExampleDistanceFieldFonts() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleDistanceFieldFonts()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleDistanceFieldFonts)