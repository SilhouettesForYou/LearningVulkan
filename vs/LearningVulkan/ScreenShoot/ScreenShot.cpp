...
class VulkanExampleScreenShot : public VulkanBase
{
public:
	...
	VulkanExampleScreenShot() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleScreenShot)