...
class VulkanExampleDynamicUniformBufffer : public VulkanBase
{
public:
	struct {
	...
	VulkanExampleDynamicUniformBufffer() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleDynamicUniformBufffer()
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleDynamicUniformBufffer)