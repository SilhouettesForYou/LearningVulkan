...
class VulkanExampleComputeRayTracing : public VulkanBase
{
public:
	...
	VulkanExampleComputeRayTracing() : VulkanBase(ENABLE_VALIDATION)
	{
	...
	~VulkanExampleComputeRayTracing()
	{
		// Graphics
...
VULKAN_EXAMPLE_MAIN(VulkanExampleComputeRayTracing)