...
class VulkanExampleDeferredShadows : public VulkanBase
{
public:
	...
	VulkanExampleDeferredShadows() : VulkanBase(ENABLE_VALIDATION)
	{
...
VULKAN_EXAMPLE_MAIN(VulkanExampleDeferredShadows)